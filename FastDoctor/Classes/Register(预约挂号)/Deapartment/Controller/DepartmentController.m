...
@interface DepartmentController ()<UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
...
//@property (strong, nonatomic) NSMutableArray *leftmodel;
...
- (void)setData:(NSArray *)data
{
    ...
    DepartmentData *model = self.data[0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.leftView) {
        ...
        cell = leftcell;
            ...
            DepartmentData *dep = self.data[indexPath.row];
            cell.textLabel.text = dep.diseaseName;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.leftView) {
        ...
        DepartmentData *data = self.data[indexPath.row];
        //加载数据
